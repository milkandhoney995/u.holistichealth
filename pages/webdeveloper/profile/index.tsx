...
export default function Profile() {
  const cardList = [
    ...
    { icon: <SvgVue />, title: "Vue / Nuxt", sentence: "I've experienced 2.5 year Front-end develpment with Vue/Nuxt. On previous project, I have both experience of implementing new function into existing app, and of creating website from the ground up." },
